<footer>
	...
	<p>Website designed and coded by Jacqueline Quintanilla. &copy; <?php echo date("Y"); ?></p>
</footer>
...
<script>
	// modified from https://www.w3schools.com/howto/tryit.asp?filename=tryhow_js_countdown
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    ...
    document.getElementById("fair-countdown").innerHTML = "";
      ...
      } // end if (window.location.pathname == '/about.php')
    } ); // end $(document).ready(function()
</script>  <!-- end countdown script -->
</body>
</html>