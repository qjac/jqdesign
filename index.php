...
<?php include ("header.php"); ?>
        ...
        <section class="portfolio">
	        ...
	        <figure class="portfolio-item">
		        <a href="/jqdesign/coolcatidentity" class="hvr-trim">
		        ...
		        <figcaption>
			        ...
			        <div class="btn "><a href="/jqdesign/coolcatidentity" class="hvr-icon-forward">Take a closer look!
				        </a></div>
<!--		        </figcaption>-->
<!--		        <p class="category">identity&nbsp;development // brand&nbsp;strategy // business&nbsp;collateral&nbsp;design</p>-->
	        ...
	        <figure class="portfolio-item">
		        <a href="/jqdesign/coolcatdigital" class="hvr-trim">
		        ...
		        <figcaption>
			        ...
			        <div class="btn "><a href="/jqdesign/coolcatdigital" class="hvr-icon-forward">Take a closer look! </a></div>
			        <!--		        </figcaption>-->
			        <!--		        <p class="category">identity&nbsp;development // brand&nbsp;strategy // business&nbsp;collateral&nbsp;design</p>-->
	        </figure>

	        <figure class="portfolio-item">
		        <a href="/jqdesign/coolcatpackage" class="hvr-trim">
		        ...
		        <figcaption>
			        ...
			        <div class="btn "><a href="/jqdesign/coolcatpackage" class="hvr-icon-forward">Take a closer look! </a></div>
			        <!--		        </figcaption>-->
			        <!--		        <p class="category">identity&nbsp;development // brand&nbsp;strategy // business&nbsp;collateral&nbsp;design</p>-->
	        </figure>

	        <figure class="portfolio-item">
		        <a href="/jqdesign/emeraldcity" class="hvr-trim">
		        ...
		        <figcaption>
			        ...
			        <div class="btn "><a href="/jqdesign/emeraldcity" class="hvr-icon-forward">Take a closer look! </a></div>
			        <!--		        </figcaption>-->
			        <!--		        <p class="category">identity&nbsp;development // brand&nbsp;strategy // business&nbsp;collateral&nbsp;design</p>-->
	        </figure>
